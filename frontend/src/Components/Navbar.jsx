import { LogInIcon, ShoppingCart, User, User2Icon, UserPlus } from "lucide-react"
      ...
      <div className="container mx-auto px-4 py-3 ">
        ...
        <nav className="flex flex-wrap items-center gap-5 ">
          ...
          <Link to={"/cart"} className="relative group"><ShoppingCart className=" inline-block mr-1 group-hover:text-pupkin_spice text-gray-200" size={20} />
            <span className="hidden sm:inline text-gray-200 hover:text-pupkin_spice transition-all ease-in-out duration-300">Cart</span>
            <span className="absolute -top-3 -right-4 bg-orange-700 text-white text-xs  rounded-full px-2 py-0.5 group-hover:bg-pupkin_spice transition-all ease-in-out duration-300">
              3
            </span>
          </Link>
          {user ? (
            <Link to={"/account"} className="relative group"><User2Icon className=" inline-block mr-1 group-hover:text-pupkin_spice text-gray-200" size={20} />
              <span className="hidden sm:inline text-gray-200 hover:text-pupkin_spice transition-all ease-in-out duration-300">Account</span>
